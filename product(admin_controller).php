...
class ControllerCatalogProduct extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		$data['entry_oe'] = $this->language->get('entry_oe');


		$data['entry_o'] = $this->language->get('entry_o'); 
		$data['entry_articul_dop'] = $this->language->get('entry_articul_dop');
		$data['help_o'] = $this->language->get('help_o'); 

		$data['help_articul_dop'] = $this->language->get('help_articul_dop');
		$data['entry_d1'] = $this->language->get('entry_d1');
		$data['help_d1'] = $this->language->get('help_d1'); 

		$data['entry_norma'] = $this->language->get('entry_norma');
		$data['help_norma'] = $this->language->get('help_norma'); 

		$data['entry_range'] = $this->language->get('entry_range');
		$data['help_range'] = $this->language->get('help_range'); 

		$data['entry_color'] = $this->language->get('entry_color');
		$data['help_color'] = $this->language->get('help_color');
		
		$data['entry_name_short'] = $this->language->get('entry_name_short');
		$data['help_name_short'] = $this->language->get('help_name_short');
		
		$data['entry_thickness'] = $this->language->get('entry_thickness');
		$data['help_thickness'] = $this->language->get('help_thickness');
		
        $data['entry_obd'] = $this->language->get('entry_obd');
        $data['entry_osd'] = $this->language->get('entry_osd');
        $data['entry_w'] = $this->language->get('entry_w');
		$data['entry_a'] = $this->language->get('entry_a');
        $data['entry_b'] = $this->language->get('entry_b');
        ...
        $data['help_oe'] = $this->language->get('help_oe');
        $data['help_obd'] = $this->language->get('help_obd');
        $data['help_osd'] = $this->language->get('help_osd');
        $data['help_w'] = $this->language->get('help_w');
		$data['help_a'] = $this->language->get('help_a');
        $data['help_b'] = $this->language->get('help_b');
        $data['help_l'] = $this->language->get('help_l');
        ...
        if (isset($this->request->post['size'])) {
         ...
         if (isset($this->request->post['obd'])) {
			$data['obd'] = $this->request->post['obd'];
		} elseif (!empty($product_info)) {
			$data['obd'] = $product_info['obd'];
		} else {
			$data['obd'] = '';
		}

         if (isset($this->request->post['osd'])) {
			$data['osd'] = $this->request->post['osd'];
		} elseif (!empty($product_info)) {
			$data['osd'] = $product_info['osd'];
		} else {
			$data['osd'] = '';
		}

         if (isset($this->request->post['w'])) {
			$data['w'] = $this->request->post['w'];
		} elseif (!empty($product_info)) {
			$data['w'] = $product_info['w'];
		} else {
			$data['w'] = '';
		}

	if (isset($this->request->post['a'])) {
			$data['a'] = $this->request->post['a'];
		} elseif (!empty($product_info)) {
			$data['a'] = $product_info['a'];
		} else {
			$data['a'] = '';
		}

         if (isset($this->request->post['b'])) {
			$data['b'] = $this->request->post['b'];
		} elseif (!empty($product_info)) {
			$data['b'] = $product_info['b'];
		} else {
			$data['b'] = '';
		}
		...
		if (isset($this->request->post['o'])) {
			...
			$data['o'] = $product_info['o'];
		} else {
			$data['o'] = '';
		}
		if (isset($this->request->post['articul_dop'])) {
			$data['articul_dop'] = $this->request->post['articul_dop'];
		} elseif (!empty($product_info)) {
			$data['articul_dop'] = $product_info['articul_dop'];
		} else {
			$data['articul_dop'] = '';
		}
		if (isset($this->request->post['d1'])) {
			$data['d1'] = $this->request->post['d1'];
		} elseif (!empty($product_info)) {
			$data['d1'] = $product_info['d1'];
		} else {
			$data['d1'] = '';
		}
		if (isset($this->request->post['norma'])) {
			$data['norma'] = $this->request->post['norma'];
		} elseif (!empty($product_info)) {
			$data['norma'] = $product_info['norma'];
		} else {
			$data['norma'] = '';
		}
		...
		if (isset($this->request->post['name_short'])) {
			$data['name_short'] = $this->request->post['name_short'];
		} elseif (!empty($product_info)) {
			$data['name_short'] = $product_info['name_short'];
		} else {
			$data['name_short'] = '';
		}
		if (isset($this->request->post['thickness'])) {
			...
			$data['thickness'] = $product_info['thickness'];
		} else {
			$data['thickness'] = '';
		}
        ...
        if ($this->config->get('config_product_size_hide') != 0) {
			$data['hide_size'] = true;
		} else {
			$data['hide_size'] = false;
		}	


		if ($this->config->get('config_d1_hide') != 0) {
			$data['hide_d1'] = true;
		} else {
			$data['hide_d1'] = false;
		}
		
		if ($this->config->get('config_norma_hide') != 0) {
			$data['hide_norma'] = true;
		} else {
			$data['hide_norma'] = false;
		}
        if ($this->config->get('config_product_oe_hide') != 0) {
			$data['hide_oe'] = true;
		} else {
			$data['hide_oe'] = false;
		}
         
        if ($this->config->get('config_product_obd_hide') != 0) {
			$data['hide_obd'] = true;
		} else {
			$data['hide_obd'] = false;
		}
         
        if ($this->config->get('config_product_osd_hide') != 0) {
			$data['hide_osd'] = true;
		} else {
			$data['hide_osd'] = false;
		}
         
        if ($this->config->get('config_product_w_hide') != 0) {
			$data['hide_w'] = true;
		} else {
			$data['hide_w'] = false;
		}

	if ($this->config->get('config_product_a_hide') != 0) {
			$data['hide_a'] = true;
		} else {
			$data['hide_a'] = false;
		}
         
        if ($this->config->get('config_product_b_hide') != 0) {
			$data['hide_b'] = true;
		} else {
			$data['hide_b'] = false;
		}
         
        if ($this->config->get('config_product_l_hide') != 0) {
			$data['hide_l'] = true;
		} else {
			$data['hide_l'] = false;
		}
		...
		if ($this->config->get('config_product_o_hide') != 0) {
			$data['hide_o'] = true;
		} else {
			$data['hide_o'] = false;
		}
		
		if ($this->config->get('config_product_articul_dop_hide') != 0) {
			$data['hide_articul_dop'] = true;
		} else {
			$data['hide_articul_dop'] = false;
		}
		if ($this->config->get('config_product_range_hide') != 0) {
			$data['hide_range'] = true;
		} else {
			$data['hide_range'] = false;
		}
		if ($this->config->get('config_product_color_hide') != 0) {
			$data['hide_color'] = true;
		} else {
			$data['hide_color'] = false;
		}
		if ($this->config->get('config_product_name_short_hide') != 0) {
			$data['hide_name_short'] = true;
		} else {
			$data['hide_name_short'] = false;
		}
		if ($this->config->get('config_product_thickness_hide') != 0) {
			$data['hide_thickness'] = true;
		} else {
			$data['hide_thickness'] = false;
		}
