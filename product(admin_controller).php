...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		d1 = '" . $this->db->escape($data['d1']) ."', 
		size = '" . $this->db->escape($data['size']) . "', 
		o = '" . $this->db->escape($data['o'])  . "', 
		articul_dop = '" . $this->db->escape($data['articul_dop'])  . "', 
		norma = '" . $this->db->escape($data['norma']) . "', 
		color = '" . $this->db->escape($data['color']) . "',
		range = '" . $this->db->escape($data['range']) . "',
		name_short = '" . $this->db->escape($data['name_short']) . "',
		thickness = '" . $this->db->escape($data['thickness']) . "',
		oe = '" . $this->db->escape($data['oe']) . "', 
		obd = '" . $this->db->escape($data['obd']) . "',
		osd = '" . $this->db->escape($data['osd']) . "', 
		w = '" . $this->db->escape($data['w']) . "', 
		a = '" . $this->db->escape($data['a']) . "', 
		b = '" . $this->db->escape($data['b']) . "', 
		l = '" . $this->db->escape($data['l']) . "', 
