                ...
                <div class="oct-specification">
                  <!--
                                    <div class="table table-responsive table-striped table-hover">
                                      ...
                                      <div  class="row">
                                        <div class="col-xs-5">
                                          <div class="attr-td"><b><?php //echo $attribute['name']; ?></b></div>
                                        </div>
                                        <div class="col-xs-7">
...
<!--        <div id="product">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12 price-col"<?php if ($tech_pr_micro == "on") { ?> itemprop="offers" itemscope itemtype="https://schema.org/Offer"<?php } ?>>
                  <?php if ($tech_pr_micro == "on") {  ?>
                ...
                <div class="col-lg-5 col-md-4 col-sm-6" style="display: none">
...
<!-- Block product options -OFF -->
              ...
              <?php } ?>
              <div class="row product-buttons-row" style="display: none">
                <div class="col-sm-12">
                  <div class="product-buttons-box<?php if ($disable_buy != 0) { ?> preorder-buttons-box<?php } ?>">
                    <?php if ($disable_buy == 0) { ?>
                    <a href="javascript:void(0);" data-toggle="tooltip" id="button-cart" title="<?php echo $button_cart; ?>" data-loading-text="<?php echo $text_loading; ?>" class="oct-button">
                        <i class="fa fa-shopping-basket hidden-lg hidden-md" aria-hidden="false"></i>
                        <span class="hidden-sm hidden-xs"><?php echo $button_cart; ?></span></a>
...
<!--   <div class="oct-carousel-row oct-related-row" style="display: none!important;>
...
<script>
  ...
  let show = document.getElementById("showContentP")
  let hide = document.getElementById("hideContentP")

  show.addEventListener("click", () => {
    content.style.display = "block";
    showContentP.style.display = "none";
    hideContentP.style.display = "block"
  })

  hide.addEventListener("click", () => {
    content.style.display = "none";
    showContentP.style.display = "block";
    hideContentP.style.display = "none"
  })
</script>
<?php echo $footer; ?>
