...
class ModelCatalogCategory extends Model {
    ...
    public function getCategoryToolsId($category_id) {
        $query = $this->db->query("SELECT category_id, tools_id, models_tools FROM " . DB_PREFIX . "category WHERE category_id = '" . (int)$category_id . "'");
